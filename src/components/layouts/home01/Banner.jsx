    ...
    render() {
      ...
      >
        Download Resume    </Link>
                            ...
                            <Box>
                                <span style={{  position: 'relative',left: '150px',top: '0px'}}>
                            ...
                            <Box component={'ul'}  color={'white'}  style={{  position: 'relative',left: '-80px'}}>
                            {info.miniBio.map((bio, index) => (
                                <EmojiBullet key={index} emoji={bio.emoji} text={bio.text}/>
                            ))}
                            </Box>
                            <Box display={'flex'} gap={'3rem'} justifyContent={'center'} fontSize={{xs: '3rem', md: '2.5rem'}} style={{  position: 'relative',left: '-100px'}}>
